...
A full-stack e-commerce application built with **Next.js App Router** featuring authentication, product management, shopping cart, reviews, favorites, order history, admin dashboard, image uploads, and Stripe payments.
...
A React single-page e-commerce application that allows users to browse products, search and filter the catalog, manage a shopping cart, authenticate, and place orders using the public Strapi Store API.
...
## 📊 GitHub GraphQL Dashboard

A React application for searching GitHub users and visualizing their public profile statistics. The app fetches data from the GitHub GraphQL API and presents repository languages, stars, and forks through interactive charts.
